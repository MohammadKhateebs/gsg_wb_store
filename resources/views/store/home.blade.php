<x-store-layout>
            ...
            <div class="ps-section__content">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{ asset('assets/store/images/blog/1.jpg') }}" alt=""></div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                        <div class="ps-post">
                            <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{ asset('assets/store/images/blog/2.jpg') }}" alt=""></div>
    ...
    <div class="ps-home-partner">
        <div class="ps-container">
            <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="40" data-owl-nav="false" data-owl-dots="false" data-owl-item="6" data-owl-item-xs="2" data-owl-item-sm="4" data-owl-item-md="5" data-owl-item-lg="6" data-owl-duration="1000" data-owl-mousedrag="on"><a href="#"><img src="{{ asset('assets/store/images/partner/1.png') }}" alt=""></a><a href="#"><img src="{{ asset('assets/store/images/partner/2.png') }}" alt=""></a><a href="#"><img src="{{ asset('assets/store/images/partner/3.png') }}" alt=""></a><a href="#"><img src="{{ asset('assets/store/images/partner/4.png') }}" alt=""></a><a href="#"><img src="{{ asset('assets/store/images/partner/5.png') }}" alt=""></a><a href="#"><img src="{{ asset('assets/store/images/partner/6.png') }}" alt=""></a><a href="#"><img src="{{ asset('assets/store/images/partner/7.png') }}" alt=""></a><a href="#"><img src="{{ asset('assets/store/images/partner/8.png') }}" alt=""></a>
            </div>
        </div>
    </div>
